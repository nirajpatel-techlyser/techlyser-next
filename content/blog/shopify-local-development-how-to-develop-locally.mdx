---
title: "Shopify Local Development – How to Develop Locally with Shopify"
slug: "shopify-local-development-how-to-develop-locally"
date: "2019-09-29 14:54:00"
...
Local Shopify development lets you use all of your preferred development tools and interact with the Shopify platform.
...
The [Theme Kit](https://shopify.github.io/themekit/) is a cross-platform tool that works on Windows, Linux, and macOS. Theme Kit allows you to use workflow tools like Git, use your preferred text editor, and work on your theme with a team.



### **Shopify Development Done Locally: What You Need**
...
* For Linux and macOS, you will need to find the Theme Kit binary specifically for the system you use, and download it. You can [find all available versions](https://shopify.github.io/themekit/#installation) on the Shopify Github.
...
API credentials give Theme Kit access to your store and the theme files you have in the store. To get API credentials, do the following:
...
* The simplest way to get this number is to find it via the Theme Editor:
  + Go to your store, and navigate to “Themes.”
  ...
  + The theme number will appear in the URL: *https://your\_store.myshopify.com/admin/themes/****numberswillbehere****.*
...
Finally, you want all changes you make in the local Shopify development environment to automatically be reflected on the theme in your Shopify store. To do that, navigate to your theme directory in the Theme Kit and run the command *theme watch.*
...
Need help with [custom Shopify theme development](http://techlyser.com//)?  Contact our experts today – we are one of the highest-rated [Shopify experts](http://techlyser.com//) in the world.